  	...
  	<div class="container">
    	...
    	<div class="footercredits clearfix">
        	...
        	<?php if(!empty($pinnacle['footer_text'])) { 
        		...
        		$footerstring = str_replace( '[theme-credit]','- WordPress Theme by <a href="https://www.kadencewp.com/" rel="nofollow noopener" target="_blank">Gruppe 10 WP</a>',$footerstring );
